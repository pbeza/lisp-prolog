...
/* Zapytaj o wyrażenie i zmienną do różniczkowania, zróżniczkuj wyrażenie po tej zmiennej, uprość wynik i wypisz, potem zapętl */
process( Exp ) :-
   write('Rozniczkuj po :'),
   read( Wrt ),
   diff( Exp, Wrt, Diff ),
...
/* d/dx U/V, gdzie U i V dowolne */
/* Można by tu złapać dzielenie przez 0 */
...
/* Dzielenie zera (tu można by wywalić błąd przy dzieleniu przez 0) */
simplify( 0/_X, 0 ).
